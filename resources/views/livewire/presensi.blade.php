    ...
    <x-layouts.app>
        ...
        <div class="p-4 space-y-4">
            ...
            <div class="bg-white rounded-xl border border-gray-100 shadow p-3">
                ...
                <div class="grid grid-cols-4 gap-2 text-center">
                    ...
                    <!-- Total Jam Kerja -->
                    <div>
                        <div class="text-[10px] text-gray-500">Jam</div>
                    ...
                    <!-- Total Lembur -->
                    <div>
                        <div class="text-[10px] text-gray-500">Lembur</div>
                    ...
                    <!-- Total Shift Malam -->
                    <div>
                        <div class="text-[10px] text-gray-500">Shift</div>
                    ...
                    <div>
                        ...
                        <div class="text-slg font-semibold text-blue-600">
                            {{ $total_hari_kerja }}
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-2xl shadow border border-gray-100 p-4 space-y-4">
                    ...
                    <div class="grid grid-cols-3 gap-2">
                        ...
                        <div class="bg-blue-50 rounded-lg p-2 text-center border border-blue-100">
                            ...
                            <div class="text-[10px] text-gray-500 leading-tight">Jam Kerja</div>
                        ...
                        <div class="bg-orange-50 rounded-lg p-2 text-center border border-orange-100">
                            ...
                            <div class="text-[10px] text-gray-500 leading-tight">Lembur</div>
                        ...
                        <div class="bg-purple-50 rounded-lg p-2 text-center border border-purple-100">
                            ...
                            <div class="text-[10px] text-gray-500 leading-tight">Shift Malam</div>
                            <div
        ...
        <div
            ...
            <div class="flex justify-between p-10 py-2 text-xs">
                ...
                <!-- Slip Gaji -->
                {{-- id_karyawan 80000 adalah akun khusus untuk testing, jadi slip gaji hanya muncul jika akun ini yang
                login --}}
